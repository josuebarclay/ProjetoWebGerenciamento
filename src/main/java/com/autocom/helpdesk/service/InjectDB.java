...
public class InjectDB {
    ...
    public void injectDB() {
        ...
        Cliente cliente113 = new Cliente(null, "GERMANO ZANIN",
                "germano@gmail.com", PasswordUtil.encoder("123"), null, Perfil.CLIENTE, null);
        Cliente cliente114 = new Cliente(null, "MERCADO AFLUENTE - JEAN LUCAS ACOSTA DA SILVA",
                "jeanlucastoca19@gmail.com", PasswordUtil.encoder("123"), null, Perfil.CLIENTE, null);
        ...
        clienteRepository.saveAll(Arrays.asList(cliente1, cliente2, cliente3, cliente4, cliente5, cliente6, cliente7, cliente8, cliente9,
                ...
                cliente100, cliente101, cliente102, cliente103, cliente104, cliente105, cliente106, cliente107, cliente108, cliente109
                ,cliente110,cliente111,cliente112,cliente113,cliente114));
    }
